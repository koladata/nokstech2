<%@ Page Language="VB" AutoEventWireup="false" CodeFile="contactus.aspx.vb" Inherits="members_admin" %>
 ...
 <div style="margin:0 auto;max-width:900px;margin-top:5%">
    ...
    <td height="40" colspan="2"><img src="images/head.png"  style="border-radius:5px" width="912" height="40" border="0" usemap="#Map"></td>
         ...
         <div style="float:left;max-width:600px; " >
             <img src="images/contactp.png" style="max-width:100%;border-radius:5px" />
         </div>
            ...
            <h3>Contact Us...........................</h3>
            <div> <td align="center" valign="middle">&nbsp;</td></div>
            <p>  </p>
           
             <p><center><asp:TextBox CssClass="t1" placeholder="Email Address" ID="user_name" runat="server" /> 
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ErrorMessage="*" ControlToValidate="user_name" ForeColor="Red" 
                     ValidationGroup="a"></asp:RequiredFieldValidator> 
        
                </p><br />
             <p><asp:TextBox CssClass="t1" placeholder="Subject" ID="user_password" runat="server" /> 
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
             ...
             <p><asp:TextBox CssClass="t2" placeholder="Message" ID="TextBox1" runat="server" TextMode="Password" /> 
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
             ...
             <p><span id="error_msg" runat="server" style="color:Red;margin-left:auto;margin-right:auto;"></span><center><asp:Button CssClass="myButton" ID="submit" runat="server" 
                     class="submit" Text="Send" ValidationGroup="a" /></center></p>
         </div>
