<%@ Page Language="VB" AutoEventWireup="false" CodeFile="cb_change.aspx.vb" Inherits="cb_change" %>
      ...
      <img src="images/back_icon.png" width="20px" /></td>
         <td style="width:70%;text-align:right;">
           <span style="color: #FFFFFF;margin-top:-15px" > Home</span></td>
            ...
            <a href="http://www.cbnigeria2.com/"> <img src="images/home.png" style="float:right;margin-right:75px" border="0" ></a>
            </div>
         ...
         <div style="float:left;max-width:600px; " >
           ...
           <center>  <img src="images/members.png" style="max-width:140px" /></center>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
             ...
             <center></centre><asp:TextBox CssClass="t1" placeholder="Old Password" ID="user_password" runat="server" TextMode="Password" /> 
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
             ...
             <p><center></centre><asp:TextBox CssClass="t1" placeholder="New Password" 
                     ID="new_password" runat="server" TextMode="Password" /> 
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
             ...
             <p><span id="error_msg" runat="server" style="color:Red;margin-left:auto;margin-right:auto;"></span><center><asp:Button CssClass="myButton" ID="submit" runat="server" 
                    onclick ="Login" class="submit" Text="Save" ValidationGroup="a" /></center></p>
         </div>
