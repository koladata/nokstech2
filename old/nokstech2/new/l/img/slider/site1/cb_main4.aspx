<%@ Page Language="VB" AutoEventWireup="false" CodeFile="cb_main4.aspx.vb" Inherits="cb_main4" %>
...
<form id="Form1" runat="server" method="post">
 ...
 <div style="margin:0 auto;max-width:900px;margin-top:5%">
         ...
         <div style="width:70px;height:20px;border-radius:5px;background-color:#007CB9;padding:5px; vertical-align: top;"> 
          <a href="http://www.cbnigeria2.com/"> 
    ...
    <td height="40" colspan="2"><img src="images/head.png"  style="border-radius:5px" width="912" height="40" border="0" usemap="#Map"></td>
         ...
         <div style="float:left; border-left:50px;max-width:1000px;background-color:#d9d9d9;padding:10px; height:453px; width:500px;" >
             ...
             <p><left><b>  Beneficiary Name: </b>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                 <asp:TextBox CssClass="t1" placeholder="" ID="full_name" 
                     runat="server" /> 
             <div>
             &nbsp;
             </div>
             <p><left><b>  Bank Name: </b>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                 <asp:TextBox CssClass="t1" placeholder="" ID="address" runat="server" /> 
                              
                       <div>
             &nbsp;
             </div>
             <p><left><b>  Account Number: </b>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                 <asp:TextBox CssClass="t1" placeholder="" ID="zip_code" 
                     runat="server" /> 
             ...
             <p><left><b>  Swift Code : </b>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                 <asp:TextBox CssClass="t1" placeholder="" 
                     ID="beneficiary_bank" runat="server" /> 
                       
                       <div>
             &nbsp;
             </div>
             <p><left><b>  Iban Number: </b>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                 <asp:TextBox CssClass="t1" placeholder="" ID="account_number" 
                     runat="server" /> 
             ...
             <p><left><b>  Amount: </b>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  
                 <asp:TextBox CssClass="t1" placeholder="" ID="gold" runat="server" /> 
                       
                       
                       <div>
             &nbsp;
             </div>
             <p><left><b>  Transfer Code: </b>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;  
                 <asp:TextBox CssClass="t1" placeholder="" ID="amount" runat="server" /> 
             ...
             &nbsp;
                          ...
                          <p><left><b>  </b>  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  
                 <asp:TextBox CssClass="t1" placeholder="" ID="user_name" runat="server" /> 
...
<map name="Map"><area shape="rect" coords="655,3,907,37" href="">
</map></body>
</html>