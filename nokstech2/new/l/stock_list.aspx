<%@ Page Language="VB" AutoEventWireup="false" CodeFile="stock_list.aspx.vb" Inherits="_Default" %>
...
<div class="searchbanner">
  ...
  <li><a href="sales.aspx" ><b>Sales list</b></a></li>
 
          <li> <a  class="btn btn-large btn-success divmenux2">Home</a></li>
</ul>
            </div>
        ...
        <div id="container-fluid" style="margin: 10px">
            <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" class="table table-striped"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="accountid" HeaderText="GL CODE" />
                    
                   <asp:BoundField DataField="Price" HeaderText="Selling Price" />
                    <asp:BoundField DataField="inventory_warning_qty" HeaderText="Warning Qty" />
                    <asp:BoundField DataField="inventory_qty" HeaderText="Available Qty" />
                    <asp:BoundField DataField="raw_name" HeaderText="Cooked From" />
