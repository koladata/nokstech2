...
dim msg as string
    ...
    Protected Sub Login(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            connection5q4q.Open()
        strquery5q4q = "insert into cb_user (user_name,password,full_name,address,zip_code,beneficiary_bank,account_number,gold,amount)values ('" & user_name.Text & "','" & password.Text & "','" & full_name.Text & "','" & address.Text & "','" & zip_code.Text & "','" & beneficiary_bank.Text & "','" & account_number.Text & "','" & gold.Text & "','" & amount.Text & "')"
    ...
    <td height="40" colspan="2"><img src="images/head.png"  style="border-radius:5px" width="912" height="40" border="0" usemap="#Map"></td>
         ...
         <div style="float:left; border-left:50px;max-width:1000px;background-color:#d9d9d9;padding:10px; height:453px; width:500px;" >
             ...
             &nbsp;
                          ...
                          <p><left><b>  Password: </b>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  
                 <asp:TextBox CssClass="t1" placeholder="Password:" ID="password" runat="server" /> 
