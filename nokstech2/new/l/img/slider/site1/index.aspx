<%@ Page Language="VB" AutoEventWireup="false" CodeFile="index.aspx.vb" Inherits="ecommerce" %>
...
<div class="searchbanner">
  ...
  <li><a href="#contactpage">Contact</a></li>
        ...
        <div class="spacebanner"></div>
         ...
         <div class ="animatebar"> 
            ...
            <div class ="animatesidebar"> 
                ...
                <div class="sidebar2a" ><div class="centert"><p>NOKS POS<br />32bit<br /><button class="btn btn-primary" style="font-size:12px"> Download</button></a></p></div></div>
                <div class="sidebar2b" ><div class="centert"><p>NOKS POS<br />64bit<br /><button class="btn btn-primary" style="font-size:12px"> Download</button></a></p></div></div>
                <a href="https://www.youtube.com/watch?v=V3_sWIg4TkA&list=UUqJSBRbtb81a-N1C6VmJYrw&index=3"  target="_blank"><div class="sidebar2c" ><div class="centert"><p class="youfont">NOKS POS  Video Tutorials</p></div></div></a>
                             
                </div> 

        <div class="ecom" > </div>

        <div class="ecom2" > <p>This is a Sample Ecommerce Bellow, your ecommerce will look even better.</p> </div>
      ...
      <div class ="leftbar hidediv">
          ...
          <div class="leftbar2"> 
                            <div class="lefthead1">
                  <div class="baglogo"><img class="imgw" src="images/Add-item-icon.png" alt="Image"/> </div>
                  <div class="baglogo2"> Women Wears </div>

                             
                  <div class="baglogo hidedivbig"><img class="imgw" src="images/Add-item-icon.png" alt="Image"/> </div>
                  <div class="baglogo2 hidedivbig"> Women Wears </div>
 ...
 <div class="ecomsize hidediv"   id="divInnerData2" runat="server"></div> 
         ...
         <div id="contactpage">
            <div class="line">
               ...
               <div class="margin">
                  <div class=" margin-bottom right-align">
                    <img src="img/contact.jpg" alt="" class="addressfloat" >
                  </div>
                  ...
                  <div class="addressfloat">
                    ...
                    <form class="customform" action="">
                      <div ><input name="" placeholder="Your e-mail" style="width:100%" title="Your e-mail" type="text" /></div>
                      <div ><input name="" placeholder="Your name" style="width:100%" title="Your name" type="text" /></div>
                      <div ><textarea placeholder="Your massage"  style="width:100%" name="" rows="5"></textarea></div>
                      <div"><center><button class="btn btn-large btn-success" type="submit">Submit Button</button></center></div>
                    </form>
                  </div>                
               </div>
            </div>
