<%@ Page Language="VB" AutoEventWireup="false" CodeFile="login.aspx.vb" EnableEventValidation="false" Inherits="index" %>
...
<body>
	...
	<div class="main-bg">
		...
		<div class="sub-main-w3">
			...
			<div class="vertical-tab">
				...
				<div id="section2" class="section-w3ls">
					...
					<label for="option2" class="icon-left-w3pvt"><span class="fa fa-user-circle" aria-hidden="true"></span>Grandlafric</label>
					<article>
						<div class="tg">
							<h3 class="legend">Login Here</h3>
							<div class="input">
								<span class="fa fa-envelope-o" aria-hidden="true"></span>
								 <asp:TextBox ID="username2" runat="server" type="text" placeholder="User Name"  >io</asp:TextBox>
							</div>
							<div class="input">
								<span class="fa fa-key" aria-hidden="true"></span>
								<asp:TextBox ID="password2" runat="server"  type="password" placeholder="Password" name="password" >po</asp:TextBox>
							</div>
		...
		<!-- copyright -->
		<div class="copyright">
			<h2>&copy; Grandlafric (DESIGNED: NOKS)
